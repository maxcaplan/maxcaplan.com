---
title: "NSCC Redesign"
description: "An exercise in accessibility driven design with a comprehensive redesign of the nscc.ca homepage"
date: "2025-12-01"
cover: "./cover.png"
skills: ["javascript", "react", "sass"]
source-url: "https://github.com/maxcaplan/NSCC-Homepage-Redesign-Demo"
demo-url: "https://maxcaplan.github.io/NSCC-Homepage-Redesign-Demo"
---

import { Image } from "astro:assets";
import nscc_current_homepage from "./nscc_current_homepage.png";
import nscc_design_system from "./nscc_design_system.png";
import nscc_mockups from "./nscc_mockups.png";
...
<figure>
  <Image
    src={nscc_current_homepage}
    alt="Screenshot of the current nscc.ca homepage"
  />
  <figcaption>The current nscc.ca homepage</figcaption>
</figure>
...
<figure>
  <Image
    src={nscc_design_system}
    alt="Design system for the NSCC homepage redesign"
  />
  <figcaption>Design system for the NSCC homepage redesign</figcaption>
</figure>
...
<figure>
  ...
  />
  <figcaption>Mockups for the redesign of the NSCC homepage</figcaption>
</figure>
